...
Each of them has a user guide in `.pdf` that you can check to learn how to use them. There are also example files for each script, located in the `example` folders.
